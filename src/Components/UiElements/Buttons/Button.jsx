...
const Button = ({arrow,children, type, onClick,onBlur}) => {
   const styles = {
    ...
    return (
       ...
       onBlur={onBlur} 
       className={
        `${type ? styles[type] : 'bg-[#ffffff] text-secondary border-2 border-primary'}
             rounded-[50px] font-sans min-w-fit text-center  text-sm font-bold 
        `}>
        <span className="flex gap-3">
        {children}
        {arrow && <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M15.8335 10H3.3335" stroke="#124E58" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12.5 5.83301L16.0774 9.41042C16.3552 9.68817 16.4941 9.82709 16.4941 9.99967C16.4941 10.1723 16.3552 10.3112 16.0774 10.5889L12.5 14.1663" stroke="#124E58" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
}
        </span>
       </button>
