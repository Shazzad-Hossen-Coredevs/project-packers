  ...
  return (
    <div className="relative overflow-x-auto">
      <table className="w-full">
        ...
        <tbody>
          {type === "order" && data.length < 1
            ? "Loading"
            : data.map((item, index) => {
                // console.log(item.createdAt)
                return (
                  <tr key={index} className="border-y border-[#0000001c]">
                    ...
                    <td className="">
                      <div className="flex gap-2">
                        <img className="cursor-pointer opacity-70" onClick={()=> console.log("Edit row")} src={edit} alt="" />
                        <img className="cursor-pointer opacity-70" onClick={()=> console.log("Delete row")} src={dlt} alt="" />
                      </div>
                    </td>
                  </tr>
                );
      ...
      <div className="flex justify-between items-center py-6 px-4">
        ...
        <div className="flex">
          <button onClick={()=> clickHandler('decrement')} className="border p-2">
            <img src={arrowLeft} alt="" />
          </button>
          <button onClick={()=> clickHandler('increment')} className="border p-2">
